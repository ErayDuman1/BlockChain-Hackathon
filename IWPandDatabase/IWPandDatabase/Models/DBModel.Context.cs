...
namespace IWPandDatabase.Models
{
    ...
    public partial class BlockChain : DbContext
    {
        ...
        public virtual int KeyHash(string userName, string publicKey, string privateKey)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("KeyHash", userNameParameter, publicKeyParameter, privateKeyParameter);
        }
